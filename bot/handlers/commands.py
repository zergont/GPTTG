...
async def cmd_models(msg: Message):
    ...
    models_text += ("\n💡 <i>Не все модели поддерживают текст и изображения."
                    " Если выбрана несовместимая модель, запрос может завершиться ошибкой."
                    " В этом случае смените модель через /setmodel.</i>")
...
async def cmd_checkmodel(msg: Message):
    ...
    response_text = (
        ...
        f"💡 <b>Совет:</b> gpt-4o-mini имеет высокий лимит токенов"
    )
